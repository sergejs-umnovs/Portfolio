...
// 
// ѕрограмма дл€ генерации инструкции по рисованию пиксельных отрезков
// Ќужна была мне дл€ строительства в Minecraft
...
int main() {
    ...
    tg = tanf(angle);																			// 
    for (i = 1; i <= width; i++){																// цикл, в котором генерируетс€ инструкци€
        count += tg;																			// добавл€ем тангенс угла к переменной дискретной высоты
